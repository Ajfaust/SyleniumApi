...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetUpServer.Models.FinancialAccount", b =>
                {
            ...
            modelBuilder.Entity("BudgetUpServer.Models.FinancialAccountType", b =>
                {
                    b.Property<int>("FinancialAccountTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BudgetUpServer.Models.Ledger", b =>
                {
                    b.Property<int>("LedgerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BudgetUpServer.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("BudgetUpServer.Models.TransactionCategory", b =>
                {
                    b.Property<int>("TransactionCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BudgetUpServer.Models.Vendor", b =>
                {
                    b.Property<int>("VendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BudgetUpServer.Models.FinancialAccount", b =>
                {
                    b.HasOne("BudgetUpServer.Models.FinancialAccountType", "FinancialAccountType")
                        .WithMany("FinancialAccounts")
                        .HasForeignKey("FinancialAccountTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BudgetUpServer.Models.Ledger", "Ledger")
                        .WithMany("FinancialAccounts")
            ...
            modelBuilder.Entity("BudgetUpServer.Models.Transaction", b =>
                {
                    b.HasOne("BudgetUpServer.Models.FinancialAccount", "FinancialAccount")
                        .WithMany()
                    ...
                    b.HasOne("BudgetUpServer.Models.TransactionCategory", "TransactionCategory")
                        .WithMany("Transactions")
                        .HasForeignKey("TransactionCategoryId");

                    b.HasOne("BudgetUpServer.Models.Vendor", "Vendor")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("BudgetUpServer.Models.TransactionCategory", b =>
                {
                    ...
                    b.HasOne("BudgetUpServer.Models.TransactionCategory", "ParentCategory")
